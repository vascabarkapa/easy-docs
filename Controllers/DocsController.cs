...
namespace EasyDocs.Controllers
{
    ...
    public class DocsController : Controller
    {
        ...
        {
            var applicationDbContext = from d in _context.Docs
                                       select d;
            applicationDbContext = applicationDbContext.Where(doc => doc.UserId == User.FindFirstValue(ClaimTypes.NameIdentifier));

            return View(await applicationDbContext.Include(document => document.User).ToListAsync());
        }
